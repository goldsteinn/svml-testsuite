#ifndef SRC_D_THREAD_D_RSEQ_D_X86_D_X86_RSEQ_ASM_DEFS_H_
#define SRC_D_THREAD_D_RSEQ_D_X86_D_X86_RSEQ_ASM_DEFS_H_


#include "util/macro.h"
#include "thread/rseq/rseq-portable.h"

#ifdef RSEQ_GLIBC_OFFSET
#define RSEQ_AREA_START "%%fs:" V_TO_STR(RSEQ_GLIBC_OFFSET)
#else
#define RSEQ_AREA_START "%%fs:I_rseq_area@tpoff"
#endif
...
#define I_RSEQ_AREA_DEF(alignment)                                             \
...
#define RSEQ_AREA_DEF() I_RSEQ_AREA_DEF(I_rseq_alignment)


#define RSEQ_CUR_CPU() RSEQ_AREA_START "+4"
...
#define RSEQ_PREP_CS_DEF(TMP_REGISTER)                                         \
    ...
    "movq " V_TO_STR(TMP_REGISTER) ", " RSEQ_AREA_START "+8" "\n\t" /* store in ptr field in I_rseq_area. */
