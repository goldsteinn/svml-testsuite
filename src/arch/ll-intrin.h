...
#define ll_clz(x)  I_ll__bitscan(x, sizeof(int) * CHAR_BIT, I_builtin_clz)
#define ll_clzl(x) I_ll__bitscan(x, sizeof(long) * CHAR_BIT, I_builtin_clzl)
#define ll_clzll(x)                                                            \
    I_ll__bitscan(x, sizeof(long long) * CHAR_BIT, I_builtin_clzll)

#define ll_ctz(x)  I_ll__bitscan(x, sizeof(int) * CHAR_BIT, I_builtin_ctz)
#define ll_ctzl(x) I_ll__bitscan(x, sizeof(long) * CHAR_BIT, I_builtin_ctzl)
#define ll_ctzll(x)                                                            \
    I_ll__bitscan(x, sizeof(long long) * CHAR_BIT, I_builtin_ctzll)
